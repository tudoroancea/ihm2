...
def get_acados_ocp(
    ...
    ocp.constraints.lbx = np.array([-n_max, 0.0, -T_max, -delta_max])
    ocp.constraints.ubx = np.array([n_max, v_x_max, T_max, delta_max])
    ocp.constraints.idxbx_e = np.array([1, 3, 4, 5])
    ocp.constraints.lbx_e = np.array([-n_max, -v_x_max, -T_max, -delta_max])
    ocp.constraints.ubx_e = np.array([n_max, v_x_max, T_max, delta_max])
    ...
    ocp.constraints.lg = np.array([t_T * -T_dot_max, t_delta * -delta_dot_max])
